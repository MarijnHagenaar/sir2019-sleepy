...
public class TabletAskDateAction extends RobotAction {
	public final static String NAME = "askDate";

	/**
	 * @param parameters A list of 1 identifier: the question to be displayed to the
	 *                   user.
	 */
	public TabletAskDateAction(final List<Parameter> parameters) {
		super(parameters);
	}
